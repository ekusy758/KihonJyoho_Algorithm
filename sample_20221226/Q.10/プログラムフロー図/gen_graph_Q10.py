...
dot.node('nullCheck', '次の要素 は NULL?', shape='diamond', fillcolor='lightblue')
dot.node('return', '何もせず終了')
...
dot.edge('loop', 'nullCheck')
dot.edge('check2', 'nullCheck', label='No')
dot.edge('nullCheck', 'return', label='Yes')
dot.edge('nullCheck', 'del', label='No')
dot.edge('del', 'end')
